...
CREATE TABLE `chi` (
  ...
  `ngay` date NOT NULL,
  `loai` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `chi` int(11) NOT NULL
...
INSERT INTO `chi` (`id_chi`, `id_user`, `noidung`, `ngay`,`loai`, `chi`)
VALUES (1, 1, 'ăn ốc', '2019-01-03','Ăn uống', 30000),
  (
    2,
    2,
    'mua trà sữa',
...
INSERT INTO `thu` (`id_thu`, `id_user`, `noidung`, `ngay`,`loai`,`thu`)
VALUES (2, 1, 'code ra tiền','2019-01-04','Ăn uống', 200000),
  (3, 1, 'code dạo', '2019-01-04','Ăn uống', 250000),
  (4, 2, 'bán quần áo', '2019-01-05','Ăn uống', 200000);
-- --------------------------------------------------------
--
